...
class BaseBlocBuilder<Data> extends StatefulWidget {
  ...
  final Widget Function(BaseLogic<Data> cubit, BaseResponse<Data> data)?
      onSuccess;
  final Widget Function(BaseLogic<Data> cubit)? onLoading;
  final Widget Function(BaseLogic<Data> cubit, Failure data)? onError;
    ...
    return Builder(
      builder: (context) {
        ...
        if (cubit.state is BaseLogicSuccess<BaseResponse<Data>> &&
          ...
          return widget.onSuccess!(cubit, data.data!);
        }
        ...
        if (cubit.state is BaseLogicError && widget.onError != null) {
          ...
          return widget.onError!(cubit, failure.failure);
        }
